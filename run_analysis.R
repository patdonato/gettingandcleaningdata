...
setwd("C:/Users/HP/Desktop/JHU Getting and Cleaning Data/Week 4/UCI HAR Dataset")
...
feature_data <- read.table("features.txt",sep = '', stringsAsFactors = FALSE)


## Extract mean and sd only
with_mean <- str_which(feature_data$V2, '.*mean[^Freq]')
with_sd <- str_which(feature_data$V2, '.*std.*')
...
setwd("C:/Users/HP/Desktop/JHU Getting and Cleaning Data/Week 4/UCI HAR Dataset/test")
...
setwd("C:/Users/HP/Desktop/JHU Getting and Cleaning Data/Week 4/UCI HAR Dataset/train")
...
final_data %>%
    ...
    group_by(subject_ID, activity_name, variable) %>%
